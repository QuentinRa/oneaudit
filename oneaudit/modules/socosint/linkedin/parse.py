...
def define_args(parent_parser):
    ...
    linkedin_parse.add_argument('-s', '--source', dest='file_source', choices=['rocketreach'], help="The input file source.", required=True)
    ...
    try:
        with open(args.input_file, 'r', encoding='utf-8') as input_file:
            save_to_json(args.output_file, {
                "version": 1.0,
                "entries": provider.parse_records(args.file_source, args.filters, input_file),
            })
